...
import { LstUsuariosInactivos } from '../../components/usuarios/usuarios-inactivos/lst-usuarios-inactivos/lst-usuarios-inactivos';
...
const routes: Routes = [
  ...
  { path: 'usuarios-inactivos', component: LstUsuariosInactivos },
];
